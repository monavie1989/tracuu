...
function preinit() {
	...
	if (url = tinyMCEPopup.getParam("external_link_list_url"))
		document.write('<script language="javascript" type="text/javascript" src="../../../../../../lib/tiny_mce/plugins/advlink/js/' + tinyMCEPopup.editor.documentBaseURI.toAbsolute(url) + '"></script>');
}
