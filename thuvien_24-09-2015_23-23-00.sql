...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2015 at 06:23 PM
...
(3, 'SMTP_PORT', '587'),
(5, 'SMTP_AUTH', 'true'),
(6, 'SMTP_USERNAME', 'phetconuong@gmail.com'),
(7, 'SMTP_PASSWORD', '4241212735'),
(8, 'SMTP_FROM_NAME', 'Thông báo từ admin');
...
CREATE TABLE IF NOT EXISTS `tbl_term` (
  ...
  `term_status` tinyint(4) DEFAULT NULL,
...
(1, 'superuser', 'superuser', 'e10adc3949ba59abbe56e057f20f883e', 'Super User', 0, 'binh.phamvan12@gmail.com', '2015-09-17 14:59:29', '2015-09-24 21:13:02', '09123', 1, NULL),
(2, 'administrator', 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'Admin', 0, 'admin@gmail.com', '2015-09-17 15:00:15', '2015-09-23 21:22:09', '12356', 1, NULL),
(3, 'administrator', 'khongten', 'e10adc3949ba59abbe56e057f20f883e', 'Admin không tên', 0, 'khongten@123.com', '2015-09-20 03:16:46', NULL, NULL, 1, 1),
(4, 'moderator', 'thunghiem', 'e10adc3949ba59abbe56e057f20f883e', 'Thử nghiệm', 0, 'thunghiem@123.com', '2015-09-20 03:25:21', '2015-09-25 10:39:42', 'rx3EhNAlsh', 1, NULL),
...
(8, 'member', 'tenten11', 'e10adc3949ba59abbe56e057f20f883e', 'Phạm Văn Bình', 2147483647, 'binh.phamvan111@gmail.com', '2015-09-23 23:16:18', NULL, 'pmbVI0btT6', 1, NULL),
(9, 'publisher', 'chuyenvien1', '14e1b600b1fd579f47433b88e8d85291', 'Chuyên viên 1', 989279795, 'chuyenvien1@gmail.com', '2015-09-25 10:36:48', NULL, 'T5oktZ94ju', 1, NULL),
(28, 'member', 'user', 'e10adc3949ba59abbe56e057f20f883e', 'Phạm Văn Bình', 2147483647, 'binh.phamvan@gmail.com', '2015-09-24 23:02:02', NULL, 'd3sYX49IxQ', 1, NULL);
...
(28, 6, 'admin.config.*', 'admin.config.*', NULL, NULL, NULL, NULL, NULL),
(29, 7, 'admin.config.smtp', 'admin.config.smtp', NULL, NULL, NULL, NULL, NULL);
...
(12, 'admin.config.*', 'admin.config.smtp'),
(13, 'admin.*', 'admin.config.*');
