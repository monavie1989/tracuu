...
<div class="wide form">
    ...
    <div class="field-group">
        ...
        <?php echo $form->dropDownList($model,'role', array('moderator'=>'Moderator','publisher'=>'Chuyên viên cao cấp','author'=>'Chuyên viên viết bài'),array('class' => 'textField','empty'=>'Tất cả quyền','style'=>'width:162px;')); ?>
