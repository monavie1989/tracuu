...
<div class="formSep">
	...
	<div class="row-fluid">
		<div class="span6">
			<?php echo $form->labelEx($model,'post_approved'); ?>
			<?php echo $form->textField($model,'post_approved', array('class' => 'date textField')); ?>
			<?php echo $form->error($model,'post_approved'); ?>
		</div>
	</div>
