<div class="row-fluid">
    <div class="span12">
        <h3 class="heading">Thêm mới Bài Viết</h3>
        <?php
                    ...
                    <div class="row-fluid">
                        <div id="w_sort05" class="w-box">    
                            ...
                            <div class="w-box-content cnt_a">
                                <div class="sepH_b">
                                    <label for="Post_post_author"><span>Tác giả:</span> <?php echo Yii::app()->user->username; ?></label>
                                </div>
                                <div class="sepH_b">
                                    <label for="Post_post_category"><span>Chuyên mục:</span> <?php echo Common::getValueAttributesByKey('Category', 'category_name', Yii::app()->user->category_id); ?></label>
                                </div>
                                <div class="sepH_b">
