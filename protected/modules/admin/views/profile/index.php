...
<div class="row-fluid">
	<div class="span12">
		...
		<button type="submit" class="btn btn-gebo" onclick="window.location.href='<?php echo Yii::app()->createUrl('admin/profile/changepassword');?>';return false;">Change Password</button>
		<?php $this->endWidget(); ?>
		<?php
		...
		<button type="submit" class="btn btn-gebo" onclick="window.location.href='<?php echo Yii::app()->createUrl('admin/profile/update');?>';return false;">Update Profile</button>
		<?php $this->endWidget(); ?>
	</div>
</div>