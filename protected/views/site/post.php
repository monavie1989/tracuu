...
<div class="row">
    ...
    <div class="col-xs-7">
        <p style="text-align: justify;"><span class="datetime"><?php echo date('d/m/Y',  strtotime($model->post_date)); ?></span> - <strong><?php echo strip_tags($model->post_content_head); ?></strong></p>
